"""
Converters for transforming Anthropic Messages API format to Copilot format.
...
from copilot.models_anthropic import (
    AnthropicMessagesRequest,
    AnthropicMessage,
    AnthropicTool,
)
from copilot.converters_core import (
    UnifiedMessage,
    UnifiedTool,
    build_copilot_payload as core_build_copilot_payload,
...
def anthropic_to_copilot(
    request: AnthropicMessagesRequest,
    conversation_id: str,
) -> Dict[str, Any]:
    """
    Converts Anthropic Messages API request to Copilot API payload.

    Returns:
        OpenAI-format JSON dict
    """
    ...
    result = core_build_copilot_payload(
