"""
Converters for transforming OpenAI format to Copilot format.
...
from copilot.models_openai import ChatMessage, ChatCompletionRequest, Tool
...
def build_copilot_payload(
    ...
    """
    Builds complete payload for Copilot API from OpenAI request.
